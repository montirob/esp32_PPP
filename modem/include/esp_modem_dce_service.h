...
/**
 * @brief Reset the DCE to the factory settings
 *
 * @param dce Modem DCE object
 * @return esp_err_t
 *      - ESP_OK on success
...
/**
 * @brief Set incoming calls auto answer
 *
 * @param dce Modem DCE object
 * @param ringNumber  number of ring before answer
 * @return esp_err_t
 *      - ESP_OK on success
 *      - ESP_FAIL on error
 */
