...
typedef enum
{
   MODEM_NET_STA_NOT_REGISTERED,       // Not registered. ME is not currently searching a new operator to register to
   MODEM_NET_STA_REGISTERED_H_N,       // Registered, home network
   MODEM_NET_STA_SEARCHING,            // Not registered, but ME is currently searching a new operator to register to
   MODEM_NET_STA_DENIED,               // Registration denied
   MODEM_NET_STA_UNKNOWN,              // Unknown
   MODEM_NET_STA_REGISTERED_ROAMING,   // Registered, roaming
...
struct modem_dte {
    ...
    esp_err_t (*change_dte_baudrate)(modem_dte_t *dte, uint32_t baudrate);                   /*!< change dte baudrate */
